...
//////////////////////////////////////////////
    ofPushMatrix();
    //!s!//
    print.colour(66,165,208,190);
    print.read(p0004,244,103,28,0);
    
    print.read(p0004,450,298,24,0);
    
    print.read(p0011,201,165,173,0);
    
    print.read(p0010,382,384,92,0);
    
    print.read(p0002,103,101,396,0);
    
    print.read(p0002,130,208,292,0);
    
    print.read(p0004,175,104,217,0);
    
    print.read(p0006,128,144,337,0);
    
    print.read(p0009,143,207,176,0);
    
    print.read(p0007,445,109,43,0);
    //!e!//
    ofPopMatrix();
//////////////////////////////////////////////
